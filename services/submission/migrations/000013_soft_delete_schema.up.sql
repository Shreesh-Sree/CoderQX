-- File: services/submission/migrations/000013_soft_delete_schema.up.sql
...
CREATE INDEX attempts_deleted_at_idx ON submission.attempts (deleted_at) WHERE deleted_at IS NOT NULL;
