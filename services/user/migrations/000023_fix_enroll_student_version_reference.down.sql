...
-- Literal inverse of the up migration: restores 000004's original ambiguous
-- "version" reference. This reintroduces the "column reference \"version\"
-- is ambiguous" bug on purpose; a down migration must exactly undo its up
-- migration.
