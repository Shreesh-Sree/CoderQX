...
func TestListRequestPartsRejectsInvalidLimit(t *testing.T) {
	...
	request.SetPathValue("tenant_id", "018f4b0d-08f8-7c09-9ba7-efdf9c222001")
...
func TestListRequestPartsAcceptsValidRequest(t *testing.T) {
	t.Parallel()
	request := httptest.NewRequest("GET",
		"/v1/tenants/018f4b0d-08f8-7c09-9ba7-efdf9c222001/exams?limit=10", nil)
	request.SetPathValue("tenant_id", "018f4b0d-08f8-7c09-9ba7-efdf9c222001")
	...
	if tenantID != "018f4b0d-08f8-7c09-9ba7-efdf9c222001" {
		t.Fatalf("tenantID = %q, want %q", tenantID, "018f4b0d-08f8-7c09-9ba7-efdf9c222001")
	}
	if limit != 10 {
...
func TestListRequestPartsUsesDefaultLimit(t *testing.T) {
	t.Parallel()
	request := httptest.NewRequest("GET",
		"/v1/tenants/018f4b0d-08f8-7c09-9ba7-efdf9c222001/exams", nil)
	request.SetPathValue("tenant_id", "018f4b0d-08f8-7c09-9ba7-efdf9c222001")
...
func TestListRequestPartsRejectsMissingTenantID(t *testing.T) {
	...
	request := httptest.NewRequest("GET", "/v1/tenants/not-a-uuid/exams", nil)
